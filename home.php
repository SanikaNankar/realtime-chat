  ...
  <h3 class="text-center">About Us</h3>
    ...
    <div class="row mt-5 mb-4">
      <div class="col-md-6 col-lg-5 ml-auto mr-auto d-flex align-items-center mt-4 mt-md-0">
        <div>
        <div class="pl-3 pr-2">
          <h5 class="card-title">Sanika Nankar</h5>
          ...
          <a href="https://github.com/" class="btn mt-2 mr-2 btn-danger">Projects</a>
        </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-5 ml-auto mr-auto d-flex align-items-center mt-4 mt-md-0">
...
<footer class="bg-dark text-center text-white">
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2020 Copyright |
    <a class="text-white" href="https://github.com/">Sanika Nankar</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
